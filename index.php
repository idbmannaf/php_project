...
<body>
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-lg-8">
					...
					$pagi = "SELECT COUNT(*) AS total FROM tweets WHERE privacy='1' ";
					...
					$q = "SELECT * FROM `tweets` WHERE privacy = '1' LIMIT " . $recordStart . "," . PAGE_SIZE;
					// echo $q;
  ...
  <div class="post-info py-2 py-md-3 mb-3 px-auto col-md-8 col-lg-9 col-xl-7 mx-auto text-center">
	  ...
	  <span><i class="fas fa-calendar-alt"></i>&nbsp; ' . $tableRow['created'] . ' &nbsp;</span>
	  <span><i class="fas fa-comments"></i>&nbsp;399 comments</span>
  </div>
  <div class="post-content"><!-- (Main Article) Post Details -->
	  <h2 class="font-weight-bold"><a href="#">' . $tableRow['title'] . '</a></h2>
	  <p>' . mb_substr($tableRow['details'], 0, 200) . '</p>
  </div>
  <footer><a class="btn rounded-pill btn-sky mb-3" href="#">Read More&nbsp;&nbsp;<i class="fas fa-arrow-right"></i></a></footer>
';
						}
						$html .= ' </article>';
						echo $html;
						...
						<div class="category-list">
							...
							if ($allCategory->num_rows > 0) {
								while ($cate = $allCategory->fetch_assoc()) {
									echo '<a href="#">' . $cate['name'] . '<span>(86)</span></a>';
								}
							}
							?>
